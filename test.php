...
//        }
        ...
        <script type="text/javascript">
            ...
            function getCard() {
                ...
                document.getElementById.innerHTML+=("<img src='images/card/" + randCard + ".png'>");
            ...
            switch (nextCard) {
                case 3:
                    document.getElementById("cards").innerHTML+=("<img src='images/card/" + card1 + ".png'>");
                    alert("card1");
                    document.getElementById("cards").innerHTML+=("<img src='images/card/" + card2 + ".png'>");
                    alert("card2");
                    card3 = getCard();
                ...
                case 4:
                    ...
                    document.getElementById("cards").innerHTML+=("<img src='images/card/" + card2 + ".png'>");
                    alert("card2");
                    document.getElementById("cards").innerHTML+=("<img src='images/card/" + card3 + ".png'>");
                    alert("card3");
                    card4 = getCard();
                ...
                case 5:
                    ...
                    document.getElementById("cards").innerHTML+=("<img src='images/card/" + card2 + ".png'>");
                    document.getElementById("cards").innerHTML+=("<img src='images/card/" + card3 + ".png'>");
                    document.getElementById("cards").innerHTML+=("<img src='images/card/" + card4 + ".png'>");
                    card5 = getCard();
            ...
            //getCard();
            hand();
            //document.write(getCard());            
        </script>
        <div id="cards">
            
        </div>
        <img src="images/chip_2.png" onclick="hit()">
    </body>
